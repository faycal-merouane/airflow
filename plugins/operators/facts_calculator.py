...
class FactsCalculatorOperator(BaseOperator):
    ...
    def execute(self, context):
        ...
        redshift_hook.run(self.facts_sql_template.format(destination_table= self.destination_table,groupby_column= self.groupby_column,fact_column = self.fact_column,origin_table = self.origin_table))
